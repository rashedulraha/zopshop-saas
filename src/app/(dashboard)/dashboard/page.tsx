...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 pb-12">
      ...
      {/* Split Layout: 8 columns / 4 columns */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        
        {/* MAIN PANEL (2/3 Width - 8 Columns) */}
        <div className="lg:col-span-8 flex flex-col gap-6 md:gap-8">
          ...
          {/* Core Recent Transactions (Recent Sales) */}
          <RecentSalesTable data={recentSales} />
        </div>

        {/* SIDE PANEL (1/3 Width - 4 Columns) */}
        <div className="lg:col-span-4 flex flex-col gap-6 md:gap-8">
          
          {/* Accounts & Liquidity Balances (Table-less List) */}
          <div className="border border-border bg-card p-5 rounded-md flex flex-col">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-semibold text-amber-500">$4,320.00</span>
              </div>
