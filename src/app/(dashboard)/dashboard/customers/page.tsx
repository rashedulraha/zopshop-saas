                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between w-full mt-1">
                        ...
                        <span className={cn(
                          "text-xs font-medium",
                          cust.balance > 0 ? "text-emerald-500" : cust.balance < 0 ? "text-rose-500" : "text-muted-foreground"
                        )}>
                          ${Math.abs(cust.balance).toFixed(2)} {cust.balance > 0 ? "Recv" : cust.balance < 0 ? "Pay" : ""}
                        </span>
                      </div>
                    </button>
                  );
