    ...
    <div className="border border-border bg-card rounded-md overflow-hidden flex flex-col">
      <div className="p-6 border-b border-border">
        ...
        <p className="text-sm text-muted-foreground">
          Latest sales and activities from your store.
        </p>
      </div>
      <div className="divide-y divide-border flex-1 overflow-y-auto">
        {activities.map((activity) => (
          <div
            key={activity.id}
            className="p-4 sm:px-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-muted/50 transition-colors"
          >
