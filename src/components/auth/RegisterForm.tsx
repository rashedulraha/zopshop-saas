  ...
  return (
    <div className="w-full max-w-lg bg-card border border-border shadow-sm rounded-xl p-8 sm:p-10">
      ...
      <form className="flex flex-col gap-5">
        ...
        <button
          type="submit"
          className="w-full bg-primary text-primary-foreground hover:bg-primary/90 py-3 rounded-xl font-semibold shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 mt-4"
        >
          Create Account
        </button>
      </form>
