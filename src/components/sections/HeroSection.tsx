      ...
      <ResponsiveComponents>
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto relative z-10 px-4">
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold mb-8 bg-primary/10 border border-primary/20 text-indigo-300 backdrop-blur-md"
          >
          ...
          <motion.h1
            ...
            className="max-w-4xl mb-6 text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight drop-shadow-[0_4px_16px_rgba(0,0,0,0.7)]"
          >
            Smart{" "}
          ...
          <motion.p
            ...
            className="max-w-2xl mb-10 text-base md:text-lg text-white font-medium leading-relaxed drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)]"
          >
